$("document").ready(function () {
  ...
  $(".login").click(function () {
    ...
    $(".choose-instructor").attr("required", false);
  ...
  $(".account-type").change(function () {
    if ($(".account-type").val() == "student") {
      $("#choose-instructor").fadeIn(0);
      $(".choose-instructor").attr("required", true);
    } else {
      $("#choose-instructor").fadeOut(0);
      $(".choose-instructor").attr("required", false);
    }
  })
});
